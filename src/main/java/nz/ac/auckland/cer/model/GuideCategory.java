...
public class GuideCategory {
    ...
    @JoinTable(name = "guide_category_content", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "guide_category_id", referencedColumnName = "id"))
    @JsonIgnoreProperties(value = {"contentItems", "similarContentItems"}, allowSetters=true)
